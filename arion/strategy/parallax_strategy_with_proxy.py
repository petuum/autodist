"""Parallax strategy, with the local replication turned on."""
...
from autodist.strategy.ps_lb_strategy_with_proxy import PSLoadBalancingProxy


class ParallaxProxy(PSLoadBalancingProxy, AllReduce):
    """
