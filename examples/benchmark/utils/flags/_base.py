...
def define_base(data_dir=True, model_dir=True, clean=False, train_epochs=False,
    ...
    if batch_size:
        flags.DEFINE_integer(
            name="batch_size", short_name="bs", default=32, help=help_wrap(
    ...
    if hooks:
        ...
        flags.DEFINE_list(
            name="hooks", short_name="hk", default="LoggingTensorHook", help=help_wrap(
    ...
    if export_dir:
        flags.DEFINE_string(
            name="export_dir", short_name="ed", default=None, help=help_wrap(
