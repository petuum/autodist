...
from utils import benchmark_wrappers
from utils.recommendation import ncf_common
from utils.recommendation import ncf_keras_main
...
class NCFKerasAccuracy(NCFKerasBenchmarkBase):
    ...
    def __init__(self,
        ...
        default_flags['data_dir'] = os.path.join(
            root_data_dir, NCF_DATA_DIR_NAME)
...
#############################################
    ...
    def benchmark_8_gpu_tf_data_ctl_mlperf_like(self):
        ...
        FLAGS.train_dataset_path = os.path.join(
            NCF_TF_DATA_1M_BATCH_DIR_NAME, "training_cycle_*/*")
        FLAGS.eval_dataset_path = os.path.join(
            NCF_TF_DATA_1M_BATCH_DIR_NAME, "eval_data/*")
        FLAGS.input_meta_data_path = os.path.join(
            NCF_TF_DATA_1M_BATCH_DIR_NAME, "meta_data.json")
        self._run_and_report_benchmark_mlperf_like()
